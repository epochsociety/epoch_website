...
export function PageShell({ children, hideFooter = false }: { children: React.ReactNode; hideFooter?: boolean }) {
  ...
  const [theme, setTheme] = useState(() => store.getContent().globalTheme || "default");
  ...
  return (
    <div className={`min-h-screen relative overflow-x-hidden bg-background transition-colors duration-500 ${themeClass}`}>
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute top-40 -right-24 w-[420px] h-[420px] rounded-full bg-brand-blue opacity-25 blur-3xl animate-blob" style={{ animationDelay: "-6s" }} />
        <div className="absolute top-[60vh] left-1/3 w-[380px] h-[380px] rounded-full bg-brand-purple opacity-20 blur-3xl animate-blob" style={{ animationDelay: "-12s" }} />
      </div>

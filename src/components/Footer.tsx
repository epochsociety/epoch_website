    ...
    <footer className="relative mt-32 pb-10 pt-16 px-6">
      ...
      <div className="max-w-6xl mx-auto grid gap-10 md:grid-cols-3 items-start">
        ...
        <nav className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-muted-foreground">
          ...
          <Link to="/members" className="hover:text-foreground transition">Members</Link>
        ...
        <div className="flex items-center md:justify-end gap-2">
          <a href="#" aria-label="Twitter" className="w-9 h-9 rounded-full grid place-items-center bg-muted hover:bg-accent transition">
            <Twitter className="w-4 h-4" />
          </a>
          <a href="#" aria-label="Instagram" className="w-9 h-9 rounded-full grid place-items-center bg-muted hover:bg-accent transition">
            <Instagram className="w-4 h-4" />
          </a>
          <a href="#" aria-label="GitHub" className="w-9 h-9 rounded-full grid place-items-center bg-muted hover:bg-accent transition">
      ...
      <div className="max-w-6xl mx-auto mt-10 flex items-center justify-center sm:justify-start text-xs text-muted-foreground">
        <span>© <span onClick={handleYearClick} className="cursor-text select-none">{new Date().getFullYear()}</span> Epoch Society. All rights reserved.</span>
      </div>
    </footer>
  );
}

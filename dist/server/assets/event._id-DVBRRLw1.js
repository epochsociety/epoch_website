...
import { b as Route, a as Link, m as motion } from "./router-BBmLPuFF.js";
import { c as createLucideIcon, g as getSession, s as store, P as PageShell, C as Calendar } from "./PageShell-DtS1bNA_.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageShell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "px-6 pt-6 pb-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
    ...
    isStaff && /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between flex-wrap gap-4 mb-6", children: [
        ...
        session?.role === "developer" && /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "inline-flex items-center gap-2 px-5 py-2.5 rounded-full glass-strong hover:bg-card transition cursor-pointer text-sm font-medium animate-fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-3", children: [
        ...
        event.documents.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-strong rounded-2xl p-4 flex items-center gap-3", children: [
          ...
          session?.role === "developer" && /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => store.removeDocument(id, d.id), className: "w-9 h-9 rounded-full grid place-items-center bg-muted hover:bg-destructive hover:text-destructive-foreground transition", "aria-label": "Delete", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "w-4 h-4" }) })
        ] }, d.id))
      ] })
    ] })
  ] }) }) });

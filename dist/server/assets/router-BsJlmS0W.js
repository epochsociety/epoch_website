...
const appCss = "/assets/styles-Dp_UiVZl.css";
...
function Loader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex flex-col items-center justify-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            animate: { opacity: [0, 1, 1, 0], filter: ["blur(8px)", "blur(0px)", "blur(0px)", "blur(12px)"] },
            transition: { duration: 2.2, ease: [0.16, 1, 0.3, 1], times: [0, 0.4, 0.8, 1] },
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen items-center justify-center bg-background relative overflow-hidden px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-brand-gradient rounded-full blur-[120px] opacity-20 pointer-events-none mix-blend-screen" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md w-full text-center glass-strong rounded-3xl p-12 shadow-soft relative z-10 border border-border/50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-7xl md:text-8xl font-black text-foreground tracking-tighter", children: "404" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl font-bold tracking-tight text-foreground", children: "Lost in the Void" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground leading-relaxed", children: "The page you're looking for drifted off into another epoch. It might have been moved or deleted." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          ...
          children: [
            "Return to Base",
            /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "ml-2 w-4 h-4 group-hover:translate-x-1 transition-transform", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M13 7l5 5m0 0l-5 5m5-5H6" }) })
          ]
        }
      ) })
    ] })
...
function ErrorComponent({ error, reset }) {
  console.error(error);
  const router2 = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-hero-gradient px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center glass-strong rounded-3xl p-10 shadow-soft", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap justify-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "rounded-full border border-input bg-card px-5 py-2.5 text-sm font-medium hover:bg-muted transition", children: "Go home" })
    ] })
  ] }) });
}
...
const $$splitComponentImporter$a = () => import("./members-ODuZGHnJ.js");
...
const $$splitComponentImporter$9 = () => import("./login-3XnDhB-E.js");
...
const $$splitComponentImporter$8 = () => import("./gallery-Bd0H6E3K.js");
...
const $$splitComponentImporter$7 = () => import("./faq-D_AZL60e.js");
...
const $$splitComponentImporter$6 = () => import("./events-DbXP3z6F.js");
...
const $$splitComponentImporter$5 = () => import("./developer-members-BBpBWcU6.js");
...
const $$splitComponentImporter$4 = () => import("./developer-events-J4Fbmg85.js");
...
const $$splitComponentImporter$3 = () => import("./developer-xKpgyxQr.js");
...
const $$splitComponentImporter$2 = () => import("./contact-BLOOlLrp.js");
...
const $$splitComponentImporter$1 = () => import("./index-Jeq7-vZS.js");
...
const $$splitComponentImporter = () => import("./event._id-BOkewsO1.js");
const Route2 = createFileRoute("/event/$id")({
  head: () => ({
    meta: [{
...
const EventIdRoute = Route2.update({
  id: "/event/$id",
  path: "/event/$id",
  getParentRoute: () => Route$b
});
...
export {
  ...
  Route2 as b,
  router as c,
  useIsomorphicLayoutEffect as d,
  useNavigate as e,
  usePresence as f,
  isHTMLElement as i,
  motion as m,
